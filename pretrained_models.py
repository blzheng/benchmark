...
pretrained_models = {
    ...
    'shufflenetv2_x0.5': models.shufflenet_v2_x0_5(pretrained = True),
    'shufflenetv2_x1.0': models.shufflenet_v2_x1_0(pretrained = True),
    'shufflenetv2_x1.5': models.shufflenet_v2_x1_5(pretrained = False),
    'shufflenetv2_x2.0': models.shufflenet_v2_x2_0(pretrained = False),
