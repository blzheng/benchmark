...
class M(torch.nn.Module):
    ...
    def forward(self, x571, x481, x488, x495, x502, x509, x516, x523, x530, x537, x544, x551, x558, x565, x579):
...
m = M().eval()
x571 = torch.randn(torch.Size([1, 128, 7, 7]))
...
start = time.time()
output = m(x571, x481, x488, x495, x502, x509, x516, x523, x530, x537, x544, x551, x558, x565, x579)
end = time.time()
print(end-start)
