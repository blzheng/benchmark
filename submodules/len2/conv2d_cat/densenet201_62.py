...
m = M().eval()
x468 = torch.randn(torch.Size([1, 128, 14, 14]))
...
x448 = torch.randn(torch.Size([1, 32, 14, 14]))
x455 = torch.randn(torch.Size([1, 32, 14, 14]))
x462 = torch.randn(torch.Size([1, 32, 14, 14]))
x476 = torch.randn(torch.Size([1, 32, 14, 14]))
start = time.time()
