...
class M(torch.nn.Module):
    ...
    def forward(self, x389, x313, x320, x327, x334, x341, x348, x355, x362, x369, x376, x383, x397):
...
batch_size=BS
x389 = torch.randn(torch.Size([batch_size, 128, 7, 7]))
...
def print_throughput(flag):
    ...
    for i in range(10):
        output = m(x389, x313, x320, x327, x334, x341, x348, x355, x362, x369, x376, x383, x397)
