...
class M(torch.nn.Module):
    ...
    def forward(self, x410, x369, x376, x383, x390, x397, x404, x418):
...
batch_size=BS
x410 = torch.randn(torch.Size([batch_size, 128, 7, 7]))
...
def print_throughput(flag):
    ...
    for i in range(10):
        output = m(x410, x369, x376, x383, x390, x397, x404, x418)
