...
class M(torch.nn.Module):
    ...
    def forward(self, x369, x376, x383, x390, x397, x404, x411, x418, x425, x432, x439, x446, x453, x460):
...
start = time.time()
output = m(x369, x376, x383, x390, x397, x404, x411, x418, x425, x432, x439, x446, x453, x460)
end = time.time()
print(end-start)
