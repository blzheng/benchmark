...
batch_size=BS
x128 = torch.randn(torch.Size([batch_size, 112, 14, 14]))
x134 = torch.randn(torch.Size([batch_size, 288, 14, 14]))
x140 = torch.randn(torch.Size([batch_size, 64, 14, 14]))
x144 = torch.randn(torch.Size([batch_size, 64, 14, 14]))
