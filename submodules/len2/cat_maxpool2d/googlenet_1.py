...
batch_size=BS
x68 = torch.randn(torch.Size([batch_size, 192, 14, 14]))
x74 = torch.randn(torch.Size([batch_size, 208, 14, 14]))
x80 = torch.randn(torch.Size([batch_size, 48, 14, 14]))
x84 = torch.randn(torch.Size([batch_size, 64, 14, 14]))
