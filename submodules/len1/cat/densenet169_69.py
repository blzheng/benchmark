...
class M(torch.nn.Module):
    ...
    def forward(self, x369, x376, x383, x390, x397, x404, x411, x418, x425, x432, x439, x446, x453, x460, x467, x474, x481):
...
def print_throughput(flag):
    ...
    for i in range(10):
        output = m(x369, x376, x383, x390, x397, x404, x411, x418, x425, x432, x439, x446, x453, x460, x467, x474, x481)
