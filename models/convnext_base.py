...
class M(torch.nn.Module):
    def __init__(self):
        ...
        self.weight0 = torch.rand(torch.Size([128]))
        self.bias0 = torch.rand(torch.Size([128]))
        ...
        self.weight1 = torch.rand(torch.Size([128]))
        self.bias1 = torch.rand(torch.Size([128]))
        ...
        self.weight2 = torch.rand(torch.Size([256]))
        self.bias2 = torch.rand(torch.Size([256]))
        ...
        self.weight3 = torch.rand(torch.Size([512]))
        self.bias3 = torch.rand(torch.Size([512]))
        ...
        self.weight4 = torch.rand(torch.Size([1024]))
        self.bias4 = torch.rand(torch.Size([1024]))
    ...
    def forward(self, x):
        ...
        x3=self.weight0
        x4=self.bias0
        x5=torch.nn.functional.layer_norm(x2, (128,),weight=x3, bias=x4, eps=1e-06)
        ...
        x41=self.weight1
        x42=self.bias1
        x43=torch.nn.functional.layer_norm(x40, (128,),weight=x41, bias=x42, eps=1e-06)
        ...
        x80=self.weight2
        x81=self.bias2
        x82=torch.nn.functional.layer_norm(x79, (256,),weight=x80, bias=x81, eps=1e-06)
        ...
        x383=self.weight3
        x384=self.bias3
        x385=torch.nn.functional.layer_norm(x382, (512,),weight=x383, bias=x384, eps=1e-06)
        ...
        x423=self.weight4
        x424=self.bias4
        x425=torch.nn.functional.layer_norm(x422, (1024,),weight=x423, bias=x424, eps=1e-06)
