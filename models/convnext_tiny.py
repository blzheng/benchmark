...
class M(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        x185=self.weight3
        x186=self.bias3
        x187=torch.nn.functional.layer_norm(x184, (384,),weight=x185, bias=x186, eps=1e-06)
        x188=x187.permute(0, 3, 1, 2)
        x189=self.conv2d18(x188)
        x190=self.layer_scale15
        ...
        x225=self.weight4
        x226=self.bias4
        x227=torch.nn.functional.layer_norm(x224, (768,),weight=x225, bias=x226, eps=1e-06)
