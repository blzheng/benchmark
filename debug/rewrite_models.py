...
rewrite_model("models/"+name.replace("/", "_")+".py", inputs_dict, module_dict, attr_dict, forward_list)
rewrite_model_temp("temp/"+name.replace("/", "_")+".py", inputs_dict, module_dict, attr_dict, forward_list)
